...
class WelcomeCog(commands.Cog):
    ...
    async def cmd_update_welcome(self, ctx):
        ...
        embed.add_field(name="Boty McBotface",
                        value="Boty ist der Server-Bot und kann dein Freund und Helfer sein, wenn es um die Organisation deines Studiums geht. In #bot-übungsplatz kann man mit den verschiedenen Befehlen rumprobieren, bei `help` wird er dir per Direktnachricht einen Überblick von seinen Funktionen geben.", 
